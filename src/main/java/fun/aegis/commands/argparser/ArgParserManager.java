...
package fun.aegis.commands.argparser;

import fun.aegis.utils.client.managers.api.command.argparser.IArgParser;
...
import fun.aegis.utils.client.managers.api.command.exception.CommandNoParserForTypeException;
