...
package fun.aegis.commands.argument;
...
import fun.aegis.utils.client.managers.api.command.datatypes.IDatatype;
import fun.aegis.utils.client.managers.api.command.datatypes.IDatatypeContext;
import fun.aegis.utils.client.managers.api.command.datatypes.IDatatypeFor;
import fun.aegis.utils.client.managers.api.command.datatypes.IDatatypePost;
import fun.aegis.utils.client.managers.api.command.exception.CommandException;
import fun.aegis.utils.client.managers.api.command.exception.CommandInvalidTypeException;
import fun.aegis.utils.client.managers.api.command.exception.CommandNotEnoughArgumentsException;
import fun.aegis.utils.client.managers.api.command.exception.CommandTooManyArgumentsException;
