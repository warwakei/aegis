package fun.aegis.utils.display.atlasfont.msdf;
...
import fun.aegis.utils.display.atlasfont.msdf.FontData.AtlasData;
import fun.aegis.utils.display.atlasfont.msdf.FontData.MetricsData;
