...
public class UpdaterEntrypoint implements PreLaunchEntrypoint {
    ...
    // Pattern to extract version from jar filename: AegisNeo-0.6.0.jar -> 0.6.0
     ...
     * Expected tag format: vX.X.X-stage (e.g., v0.6.0-beta)
     * Returns version without 'v' prefix (e.g., 0.6.0-beta)
     */
